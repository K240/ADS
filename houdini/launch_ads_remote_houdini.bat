...
if not defined ADS_CATALOG_SERVER set "ADS_CATALOG_SERVER=%ADS_RESOLVER_SERVER%"
if not defined ADS_CATALOG_PROFILE set "ADS_CATALOG_PROFILE=%ADS_RESOLVER_PROFILE%"
if not defined ADS_CATALOG_API_TOKEN set "ADS_CATALOG_API_TOKEN=%ADS_RESOLVER_API_TOKEN%"
...
if not defined ADS_CATALOG_RESOLVE_MODE set "ADS_CATALOG_RESOLVE_MODE=remote"

set "ADS_PLUGIN_RESOURCES=%ADS_REPO_ROOT%\resolver\build\houdini\resources"
set "ADS_HOUDINI_PATH=%ADS_REPO_ROOT%\houdini"
set "ADS_HUSDPLUGINS_PATH=%ADS_REPO_ROOT%\houdini\husdplugins"
...
if defined HOUDINI_HUSDPLUGINS_PATH (
    set "HOUDINI_HUSDPLUGINS_PATH=%ADS_HUSDPLUGINS_PATH%;%HOUDINI_HUSDPLUGINS_PATH%"
) else (
    set "HOUDINI_HUSDPLUGINS_PATH=%ADS_HUSDPLUGINS_PATH%;&"
)
...
echo   ADS_CATALOG_SERVER=%ADS_CATALOG_SERVER%
echo   ADS_CATALOG_PROFILE=%ADS_CATALOG_PROFILE%
...
echo   HOUDINI_HUSDPLUGINS_PATH=%HOUDINI_HUSDPLUGINS_PATH%
